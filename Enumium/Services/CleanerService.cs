    ...
    public class CleanerService
    {
        public static async Task<List<Models.CleanerItem>> ScanAsync(IProgress<string>? progress = null)
        {
            ...
            await Task.Run(() =>
            {
                ...
                ScanDirectory(items, Path.GetTempPath(), "Windows Temp", "🗑️");
                ...
                ScanDirectoryPattern(items, thumbPath, "thumbcache_*.db", "Thumbnail Cache", "🖼️");
                ...
                ScanDirectory(items, @"C:\ProgramData\Microsoft\Windows\WER", "Error Reports", "⚠️");
